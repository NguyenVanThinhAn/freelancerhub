              ...
              {list.items.map((d) => (
                ...
                >
                  ...
                  <p className="line-clamp-2 text-[9px] text-slate-400">
                    {(d.description || d.reason || '').slice(0, 100)}
                    {(d.description || d.reason || '').length > 100 ? "…" : ""}
                  </p>
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-lg border border-amber-100 bg-amber-50/50 p-3">
                ...
                <p className="mt-1 whitespace-pre-line text-[10px] text-slate-700">
                  {dispute.description || (dispute as any).reason || (
                    <span className="italic text-slate-400">(không có mô tả)</span>
                  )}
                </p>
                {dispute.reason_code && (
                  <p className="mt-1 text-[9px] text-slate-500">
                    Mã: <span className="font-mono">{dispute.reason_code}</span>
                  </p>
                )}
              </div>
