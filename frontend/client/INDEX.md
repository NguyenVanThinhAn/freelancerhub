...
| 13 | `pages/Wallet.tsx` | `/wallet` | ✅ | Thanh toán | "Thanh toán" | **Protected** · wire useWallet |
| 15 | `pages/NotFound.tsx` | `*` | ❌ | — | — | n/a |

**Tổng:** 15 page (14 + Login). Tất cả (trừ `/login`) là **Protected** → `<ProtectedRoute>`.
...
### Contract Flow
```
ContractMilestone → MyProjects (danh sách hợp đồng sau khi tạo)
```
